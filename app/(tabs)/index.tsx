...
import {
  ...
  Pressable, ActivityIndicator, Modal, Button,
} from 'react-native';
...
export default function TasksScreen() {
  ...
  const handleSave = async () => {
    ...
    if (isUpdating) {
      await storeUpdateTask(taskId, text, completed, formattedDate);
    } else {
      await storeAddTask(text, completed, formattedDate);
    }
    resetForm();
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <Modal visible={modalVisible} transparent={true} animationType="fade" onRequestClose={resetForm}>
